...
export class ManageChemistComponent implements OnInit {
    ...
    constructor(public dialog: MatDialog, private chemService: ChemistService, private toastr: ToastrService, private router: Router, private configService: ConfigService) {
